...
sleep 1
clear
figlet WELCOME NJING | lolcat
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  ICT-FAKE  "$i"                    "
echo $i""$pu"  WhatsApp:  0888099xxxxx"$i"                "
echo $i""$pu"  GMAIL   :  fakegmail12@gmail.com"$i"     "
echo $i""$pu"  PLANET  :  MARS"$i"                    "
echo $pur"==================="$cy" ============================="
echo
...
echo
echo $pur"ICT-FAKE["$pur"Masukkan pilihan anda"$pur"]"
read -p"ICT-FAKE>> " pil
...
sleep 2
echo $ku"Facebook :"$i" errorbysystem"
echo $ku"YouTube  :"$i" YouTube Asede Kontol:*"
echo $ku"WhatsApp :"$i" 0887882xxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { ASEDE KONTOL:*  }"
exit
fi
